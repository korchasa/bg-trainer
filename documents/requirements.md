...
- **Only the question is pinned.** The instruction and the worked example repeat verbatim on every question of a session and are the tallest part of the stack (120–155 px against the question's 63–126 px), so pinning them would spend the screen on text already read. Pinned this way the block costs 11–27 % of the play area.
