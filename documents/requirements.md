...
### 3.10 FR-LESSONS
- **Desc:** 8 lessons aligned with textbook `documents/lessons/lesson-1..8.md`. Each lesson has `id`, `num`, `title`, `modeIds[]`, `available`. Lessons 1–5 are fully playable; lessons 6–8 show as "Скоро" placeholders.
