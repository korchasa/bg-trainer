...
- **Acceptance:**
  ...
  - [x] All 241 non-`paradigm` modes carry ru + uk models. Evidence: `src/data/index.ts`, `deno task test` → "Scanned 251 modes"
...
- **Acceptance:**
  ...
  - [x] Answers stay character-identical to their fixed option sets across all 44 `pickOpt` modes; no answer duplicates its own decoys. Evidence: verified over all 251 modes / 3955 items — 0 mismatches
