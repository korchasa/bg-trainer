...
export const DATA_ARTICLE: DataItem[] = [
  ...
  { q: "брат", label: LABEL_M, answer: "-ът", hint: { ru: "брат", uk: "брат" }, rule: ART_M_RULE },
  { q: "учител", label: LABEL_M, answer: "-ът", hint: { ru: "учитель", uk: "вчитель" }, rule: ART_M_RULE },
  { q: "приятел", label: LABEL_M, answer: "-ът", hint: { ru: "друг", uk: "друг" }, rule: ART_M_RULE },
  { q: "син", label: LABEL_M, answer: "-ът", hint: { ru: "сын", uk: "син" }, rule: ART_M_RULE },
  { q: "език", label: LABEL_M, answer: "-ът", hint: { ru: "язык", uk: "мова" }, rule: ART_M_RULE },
  { q: "сестра", label: LABEL_F, answer: "-та", hint: { ru: "сестра", uk: "сестра" }, rule: ART_F_RULE },
  { q: "тетрадка", label: LABEL_F, answer: "-та", hint: { ru: "тетрадь", uk: "зошит" }, rule: ART_F_RULE },
  { q: "химикалка", label: LABEL_F, answer: "-та", hint: { ru: "ручка", uk: "ручка" }, rule: ART_F_RULE },
  { q: "чанта", label: LABEL_F, answer: "-та", hint: { ru: "сумка", uk: "сумка" }, rule: ART_F_RULE },
  { q: "държава", label: LABEL_F, answer: "-та", hint: { ru: "страна", uk: "країна" }, rule: ART_F_RULE },
  { q: "ябълка", label: LABEL_F, answer: "-та", hint: { ru: "яблоко", uk: "яблуко" }, rule: ART_F_RULE },
  { q: "сърце", label: LABEL_N, answer: "-то", hint: { ru: "сердце", uk: "серце" }, rule: ART_N_RULE },
  { q: "куче", label: LABEL_N, answer: "-то", hint: { ru: "собака", uk: "собака" }, rule: ART_N_RULE },
  { q: "момиче", label: LABEL_N, answer: "-то", hint: { ru: "девочка", uk: "дівчинка" }, rule: ART_N_RULE },
  { q: "момче", label: LABEL_N, answer: "-то", hint: { ru: "мальчик", uk: "хлопчик" }, rule: ART_N_RULE },
  { q: "столове", label: LABEL_PL, answer: "-те", hint: { ru: "стулья", uk: "стільці" }, rule: ART_PL_I_RULE },
  { q: "учители", label: LABEL_PL, answer: "-те", hint: { ru: "учителя", uk: "вчителі" }, rule: ART_PL_I_RULE },
  { q: "дървета", label: LABEL_PL, answer: "-та", hint: { ru: "деревья", uk: "дерева" }, rule: ART_PL_A_RULE },
  { q: "морета", label: LABEL_PL, answer: "-та", hint: { ru: "моря", uk: "моря" }, rule: ART_PL_A_RULE },
  { q: "села", label: LABEL_PL, answer: "-та", hint: { ru: "сёла", uk: "села" }, rule: ART_PL_A_RULE },
  { q: "езици", label: LABEL_PL, answer: "-те", hint: { ru: "языки", uk: "мови" }, rule: ART_PL_I_RULE },
  { q: "кучета", label: LABEL_PL, answer: "-та", hint: { ru: "собаки", uk: "собаки" }, rule: ART_PL_A_RULE },
  { q: "приятели", label: LABEL_PL, answer: "-те", hint: { ru: "друзья", uk: "друзі" }, rule: ART_PL_I_RULE },
];
export const ARTICLE_OPTIONS = ["-ът", "-та", "-то", "-те", "-а"];

// --- Article without a gender prompt: the ending itself gives the gender ---
const GEN_ART_M_RULE: Localized<string> = {
  ru: "Слово оканчивается на согласную → мужской род → артикль -ът.",
  uk: "Слово закінчується на приголосний → чоловічий рід → артикль -ът.",
};
const GEN_ART_F_RULE: Localized<string> = {
  ru: "Слово оканчивается на -а/-я → женский род → артикль -та.",
  uk: "Слово закінчується на -а/-я → жіночий рід → артикль -та.",
};
const GEN_ART_F_EXC_RULE: Localized<string> = {
  ru: "Исключение: «нощ» оканчивается на согласную, но это женский род (как есен, пролет, вечер) → артикль -та.",
  uk: "Виняток: «нощ» закінчується на приголосний, але це жіночий рід (як есен, пролет, вечер) → артикль -та.",
};
const GEN_ART_N_RULE: Localized<string> = {
  ru: "Слово оканчивается на -о/-е → средний род → артикль -то.",
  uk: "Слово закінчується на -о/-е → середній рід → артикль -то.",
};
export const DATA_ART_GENDER: DataItem[] = [
  { q: "мъж", answer: "-ът", hint: { ru: "мужчина", uk: "чоловік" }, rule: GEN_ART_M_RULE },
  { q: "стол", answer: "-ът", hint: { ru: "стул", uk: "стілець" }, rule: GEN_ART_M_RULE },
  { q: "град", answer: "-ът", hint: { ru: "город", uk: "місто" }, rule: GEN_ART_M_RULE },
  { q: "ден", answer: "-ът", hint: { ru: "день", uk: "день" }, rule: GEN_ART_M_RULE },
  { q: "нос", answer: "-ът", hint: { ru: "нос", uk: "ніс" }, rule: GEN_ART_M_RULE },
  { q: "зъб", answer: "-ът", hint: { ru: "зуб", uk: "зуб" }, rule: GEN_ART_M_RULE },
  { q: "хляб", answer: "-ът", hint: { ru: "хлеб", uk: "хліб" }, rule: GEN_ART_M_RULE },
  { q: "вятър", answer: "-ът", hint: { ru: "ветер", uk: "вітер" }, rule: GEN_ART_M_RULE },
  { q: "жена", answer: "-та", hint: { ru: "женщина", uk: "жінка" }, rule: GEN_ART_F_RULE },
  { q: "книга", answer: "-та", hint: { ru: "книга", uk: "книга" }, rule: GEN_ART_F_RULE },
  { q: "нощ", answer: "-та", hint: { ru: "ночь", uk: "ніч" }, rule: GEN_ART_F_EXC_RULE },
  { q: "улица", answer: "-та", hint: { ru: "улица", uk: "вулиця" }, rule: GEN_ART_F_RULE },
  { q: "майка", answer: "-та", hint: { ru: "мама", uk: "мама" }, rule: GEN_ART_F_RULE },
  { q: "вода", answer: "-та", hint: { ru: "вода", uk: "вода" }, rule: GEN_ART_F_RULE },
  { q: "врата", answer: "-та", hint: { ru: "дверь", uk: "двері" }, rule: GEN_ART_F_RULE },
  { q: "дете", answer: "-то", hint: { ru: "ребёнок", uk: "дитина" }, rule: GEN_ART_N_RULE },
  { q: "море", answer: "-то", hint: { ru: "море", uk: "море" }, rule: GEN_ART_N_RULE },
  { q: "село", answer: "-то", hint: { ru: "село", uk: "село" }, rule: GEN_ART_N_RULE },
  { q: "сърце", answer: "-то", hint: { ru: "сердце", uk: "серце" }, rule: GEN_ART_N_RULE },
  { q: "яйце", answer: "-то", hint: { ru: "яйцо", uk: "яйце" }, rule: GEN_ART_N_RULE },
  { q: "небе", answer: "-то", hint: { ru: "небо", uk: "небо" }, rule: GEN_ART_N_RULE },
  { q: "дърво", answer: "-то", hint: { ru: "дерево", uk: "дерево" }, rule: GEN_ART_N_RULE },
  { q: "брат", answer: "-ът", hint: { ru: "брат", uk: "брат" }, rule: GEN_ART_M_RULE },
  { q: "учител", answer: "-ът", hint: { ru: "учитель", uk: "вчитель" }, rule: GEN_ART_M_RULE },
  { q: "приятел", answer: "-ът", hint: { ru: "друг", uk: "друг" }, rule: GEN_ART_M_RULE },
  { q: "език", answer: "-ът", hint: { ru: "язык", uk: "мова" }, rule: GEN_ART_M_RULE },
  { q: "син", answer: "-ът", hint: { ru: "сын", uk: "син" }, rule: GEN_ART_M_RULE },
  { q: "студент", answer: "-ът", hint: { ru: "студент", uk: "студент" }, rule: GEN_ART_M_RULE },
  { q: "журналист", answer: "-ът", hint: { ru: "журналист", uk: "журналіст" }, rule: GEN_ART_M_RULE },
  { q: "сестра", answer: "-та", hint: { ru: "сестра", uk: "сестра" }, rule: GEN_ART_F_RULE },
  { q: "тетрадка", answer: "-та", hint: { ru: "тетрадь", uk: "зошит" }, rule: GEN_ART_F_RULE },
  { q: "химикалка", answer: "-та", hint: { ru: "ручка", uk: "ручка" }, rule: GEN_ART_F_RULE },
  { q: "чанта", answer: "-та", hint: { ru: "сумка", uk: "сумка" }, rule: GEN_ART_F_RULE },
  { q: "държава", answer: "-та", hint: { ru: "страна", uk: "країна" }, rule: GEN_ART_F_RULE },
  { q: "ябълка", answer: "-та", hint: { ru: "яблоко", uk: "яблуко" }, rule: GEN_ART_F_RULE },
  { q: "студентка", answer: "-та", hint: { ru: "студентка", uk: "студентка" }, rule: GEN_ART_F_RULE },
  { q: "куче", answer: "-то", hint: { ru: "собака", uk: "собака" }, rule: GEN_ART_N_RULE },
  { q: "момиче", answer: "-то", hint: { ru: "девочка", uk: "дівчинка" }, rule: GEN_ART_N_RULE },
  { q: "момче", answer: "-то", hint: { ru: "мальчик", uk: "хлопчик" }, rule: GEN_ART_N_RULE },
  { q: "име", answer: "-то", hint: { ru: "имя", uk: "ім'я" }, rule: GEN_ART_N_RULE },
  { q: "писмо", answer: "-то", hint: { ru: "письмо", uk: "лист" }, rule: GEN_ART_N_RULE },
  { q: "езеро", answer: "-то", hint: { ru: "озеро", uk: "озеро" }, rule: GEN_ART_N_RULE },
  { q: "легло", answer: "-то", hint: { ru: "кровать", uk: "ліжко" }, rule: GEN_ART_N_RULE },
];
export const ART_GENDER_OPTIONS = ["-ът", "-та", "-то"];
...
export const DATA_PLURAL: DataItem[] = [
  ...
  { q: "сестра", answer: "сестри", hint: { ru: "сестра", uk: "сестра" }, decoys: ["майки", "жени", "книги"], rule: PL_RULE_FI },
  { q: "улица", answer: "улици", hint: { ru: "улица", uk: "вулиця" }, decoys: ["книги", "думи", "майки"], rule: PL_RULE_FI },
  { q: "държава", answer: "държави", hint: { ru: "страна", uk: "країна" }, decoys: ["книги", "жени", "думи"], rule: PL_RULE_FI },
  { q: "ябълка", answer: "ябълки", hint: { ru: "яблоко", uk: "яблуко" }, decoys: ["книги", "майки", "жени"], rule: PL_RULE_FI },
  { q: "син", answer: "синове", hint: { ru: "сын", uk: "син" }, decoys: ["братя", "столове", "градове"], rule: PL_RULE_M_OVE },
  { q: "приятел", answer: "приятели", hint: { ru: "друг", uk: "друг" }, decoys: ["учители", "столове", "градове"], rule: PL_RULE_MI },
  { q: "учител", answer: "учители", hint: { ru: "учитель", uk: "вчитель" }, decoys: ["приятели", "студенти", "журналисти"], rule: PL_RULE_MI },
  { q: "студент", answer: "студенти", hint: { ru: "студент", uk: "студент" }, decoys: ["учители", "приятели", "журналисти"], rule: PL_RULE_MI },
  { q: "журналист", answer: "журналисти", hint: { ru: "журналист", uk: "журналіст" }, decoys: ["студенти", "учители", "писатели"], rule: PL_RULE_MI },
  { q: "език", answer: "езици", hint: { ru: "язык", uk: "мова" }, decoys: ["приятели", "столове", "градове"], rule: PL_RULE_MI },
  { q: "море", answer: "морета", hint: { ru: "море", uk: "море" }, decoys: ["села", "кучета", "дървета"], rule: PL_RULE_N_ETA },
  { q: "село", answer: "села", hint: { ru: "село", uk: "село" }, decoys: ["морета", "кучета", "дървета"], rule: PL_RULE_N_ETA },
  { q: "име", answer: "имена", hint: { ru: "имя", uk: "ім'я" }, decoys: ["села", "морета", "деца"], rule: PL_RULE_IRREG },
  { q: "човек", answer: "хора", hint: { ru: "человек → люди", uk: "людина → люди" }, decoys: ["мъже", "деца", "братя"], rule: PL_RULE_IRREG },
  { q: "тетрадка", answer: "тетрадки", hint: { ru: "тетрадь", uk: "зошит" }, decoys: ["химикалки", "чанти", "книги"], rule: PL_RULE_FI },
  { q: "химикалка", answer: "химикалки", hint: { ru: "ручка", uk: "ручка" }, decoys: ["тетрадки", "чанти", "моливи"], rule: PL_RULE_FI },
  { q: "чанта", answer: "чанти", hint: { ru: "сумка", uk: "сумка" }, decoys: ["тетрадки", "химикалки", "книги"], rule: PL_RULE_FI },
  { q: "молив", answer: "моливи", hint: { ru: "карандаш", uk: "олівець" }, decoys: ["химикалки", "столове", "зъби"], rule: PL_RULE_MI },
  { q: "речник", answer: "речници", hint: { ru: "словарь", uk: "словник" }, decoys: ["книги", "тетрадки", "моливи"], rule: PL_RULE_MI },
];
...
export const DATA_NEGATION: DataItem[] = [
  ...
  { q: "вие сте от Полша", answer: "вие не сте от Полша", hint: { ru: "вы из Польши", uk: "ви з Польщі" } },
  { q: "ти си студент", answer: "ти не си студент", hint: { ru: "ты студент", uk: "ти студент" } },
  { q: "той е фотограф", answer: "той не е фотограф", hint: { ru: "он фотограф", uk: "він фотограф" } },
  { q: "тя говори български", answer: "тя не говори български", hint: { ru: "она говорит по-болгарски", uk: "вона розмовляє болгарською" } },
  { q: "ние говорим английски", answer: "ние не говорим английски", hint: { ru: "мы говорим по-английски", uk: "ми розмовляємо англійською" } },
  { q: "те имат деца", answer: "те нямат деца", hint: { ru: "у них есть дети", uk: "у них є діти" } },
  { q: "имаш молив", answer: "нямаш молив", hint: { ru: "у тебя есть карандаш", uk: "у тебе є олівець" } },
  { q: "имаме време", answer: "нямаме време", hint: { ru: "у нас есть время", uk: "у нас є час" } },
  { q: "тя иска кафе", answer: "тя не иска кафе", hint: { ru: "она хочет кофе", uk: "вона хоче кави" } },
  { q: "вие разбирате", answer: "вие не разбирате", hint: { ru: "вы понимаете", uk: "ви розумієте" } },
  { q: "те живеят тук", answer: "те не живеят тук", hint: { ru: "они живут здесь", uk: "вони живуть тут" } },
  { q: "ти работиш", answer: "ти не работиш", hint: { ru: "ты работаешь", uk: "ти працюєш" } },
  { q: "аз пия чай", answer: "аз не пия чай", hint: { ru: "я пью чай", uk: "я п'ю чай" } },
];
...
export const DATA_BUILD: BuildItem[] = [
  ...
  { words: ["как", "сте", "?"], translation: { ru: "Как Вы?", uk: "Як Ви?" } },
  { words: ["откъде", "сте", "?"], translation: { ru: "Откуда Вы?", uk: "Звідки Ви?" } },
  { words: ["как", "се", "казвате", "?"], translation: { ru: "Как Вас зовут?", uk: "Як Вас звати?" } },
  { words: ["с", "какво", "се", "занимаваш", "?"], translation: { ru: "Чем занимаешься?", uk: "Чим займаєшся?" } },
  { words: ["с", "какво", "се", "занимавате", "?"], translation: { ru: "Чем занимаетесь?", uk: "Чим займаєтесь?" } },
  { words: ["говорите", "ли", "български", "?"], translation: { ru: "Вы говорите по-болгарски?", uk: "Ви розмовляєте болгарською?" } },
  { words: ["кой", "е", "от", "Полша", "?"], translation: { ru: "Кто из Польши?", uk: "Хто з Польщі?" } },
  { words: ["къде", "живеете", "?"], translation: { ru: "Где Вы живёте?", uk: "Де Ви живете?" } },
  { words: ["какво", "имаш", "?"], translation: { ru: "Что у тебя есть?", uk: "Що у тебе є?" } },
  { words: ["какво", "е", "това", "?"], translation: { ru: "Что это?", uk: "Що це?" } },
  { words: ["кой", "си", "ти", "?"], translation: { ru: "Кто ты?", uk: "Хто ти?" } },
  { words: ["кога", "идвате", "?"], translation: { ru: "Когда Вы придёте?", uk: "Коли Ви прийдете?" } },
  { words: ["защо", "учиш", "български", "?"], translation: { ru: "Почему учишь болгарский?", uk: "Чому вчиш болгарську?" } },
  { words: ["колко", "е", "часът", "?"], translation: { ru: "Который час?", uk: "Котра година?" } },
  { words: ["откъде", "са", "те", "?"], translation: { ru: "Откуда они?", uk: "Звідки вони?" } },
  { words: ["имаш", "ли", "време", "?"], translation: { ru: "У тебя есть время?", uk: "Маєш час?" } },
  { words: ["искаш", "ли", "кафе", "?"], translation: { ru: "Хочешь кофе?", uk: "Хочеш кави?" } },
];
...
export const DATA_COUNTRY_LANG: DataItem[] = [
  ...
  { q: "Австрия", answer: "немски", hint: { ru: "язык Австрии", uk: "мова Австрії" }, decoys: ["английски", "френски", "италиански"] },
  { q: "Албания", answer: "албански", hint: { ru: "язык Албании", uk: "мова Албанії" }, decoys: ["гръцки", "сръбски", "турски"] },
  { q: "Холандия", answer: "нидерландски", hint: { ru: "язык Нидерландов", uk: "мова Нідерландів" }, decoys: ["немски", "английски", "френски"] },
  { q: "Хърватия", answer: "хърватски", hint: { ru: "язык Хорватии", uk: "мова Хорватії" }, decoys: ["сръбски", "словенски", "български"] },
  { q: "Словакия", answer: "словашки", hint: { ru: "язык Словакии", uk: "мова Словаччини" }, decoys: ["чешки", "полски", "унгарски"] },
  { q: "Словения", answer: "словенски", hint: { ru: "язык Словении", uk: "мова Словенії" }, decoys: ["хърватски", "сръбски", "италиански"] },
  { q: "Румъния", answer: "румънски", hint: { ru: "язык Румынии", uk: "мова Румунії" }, decoys: ["унгарски", "български", "италиански"] },
  { q: "Португалия", answer: "португалски", hint: { ru: "язык Португалии", uk: "мова Португалії" }, decoys: ["испански", "италиански", "френски"] },
  { q: "Македония", answer: "македонски", hint: { ru: "язык Македонии", uk: "мова Македонії" }, decoys: ["български", "сръбски", "гръцки"] },
  { q: "Украйна", answer: "украински", hint: { ru: "язык Украины", uk: "мова України" }, decoys: ["руски", "полски", "български"] },
  { q: "Беларус", answer: "беларуски", hint: { ru: "язык Беларуси", uk: "мова Білорусі" }, decoys: ["руски", "украински", "полски"] },
  { q: "Корея", answer: "корейски", hint: { ru: "язык Кореи", uk: "мова Кореї" }, decoys: ["японски", "китайски", "виетнамски"] },
  { q: "Виетнам", answer: "виетнамски", hint: { ru: "язык Вьетнама", uk: "мова В'єтнаму" }, decoys: ["китайски", "японски", "корейски"] },
  { q: "Бразилия", answer: "португалски", hint: { ru: "язык Бразилии", uk: "мова Бразилії" }, decoys: ["испански", "английски", "италиански"] },
  { q: "Мексико", answer: "испански", hint: { ru: "язык Мексики", uk: "мова Мексики" }, decoys: ["португалски", "английски", "френски"] },
];
...
export const DATA_NATIONALITY: DataItem[] = [
  ...
  { q: "Полша (м.)", answer: "поляк", hint: { ru: "мужчина из Польши", uk: "чоловік з Польщі" }, decoys: ["полякиня", "чех", "словак"] },
  { q: "Полша (ж.)", answer: "полякиня", hint: { ru: "женщина из Польши", uk: "жінка з Польщі" }, decoys: ["поляк", "чехкиня", "словачка"] },
  { q: "Чехия (м.)", answer: "чех", hint: { ru: "мужчина из Чехии", uk: "чоловік з Чехії" }, decoys: ["чехкиня", "словак", "поляк"] },
  { q: "Чехия (ж.)", answer: "чехкиня", hint: { ru: "женщина из Чехии", uk: "жінка з Чехії" }, decoys: ["чех", "словачка", "полякиня"] },
  { q: "Турция (м.)", answer: "турчин", hint: { ru: "мужчина из Турции", uk: "чоловік з Туреччини" }, decoys: ["туркиня", "грък", "българин"] },
  { q: "Турция (ж.)", answer: "туркиня", hint: { ru: "женщина из Турции", uk: "жінка з Туреччини" }, decoys: ["турчин", "гъркиня", "българка"] },
  { q: "Сърбия (м.)", answer: "сърбин", hint: { ru: "мужчина из Сербии", uk: "чоловік з Сербії" }, decoys: ["сръбкиня", "хърватин", "българин"] },
  { q: "Сърбия (ж.)", answer: "сръбкиня", hint: { ru: "женщина из Сербии", uk: "жінка з Сербії" }, decoys: ["сърбин", "хърватка", "българка"] },
  { q: "Унгария (м.)", answer: "унгарец", hint: { ru: "мужчина из Венгрии", uk: "чоловік з Угорщини" }, decoys: ["унгарка", "румънец", "словак"] },
  { q: "Унгария (ж.)", answer: "унгарка", hint: { ru: "женщина из Венгрии", uk: "жінка з Угорщини" }, decoys: ["унгарец", "румънка", "словачка"] },
  { q: "Франция (м.)", answer: "французин", hint: { ru: "мужчина из Франции", uk: "чоловік з Франції" }, decoys: ["французойка", "испанец", "италианец"] },
  { q: "Франция (ж.)", answer: "французойка", hint: { ru: "женщина из Франции", uk: "жінка з Франції" }, decoys: ["французин", "испанка", "италианка"] },
  { q: "Китай (м.)", answer: "китаец", hint: { ru: "мужчина из Китая", uk: "чоловік з Китаю" }, decoys: ["китайка", "японец", "корейски"] },
  { q: "Китай (ж.)", answer: "китайка", hint: { ru: "женщина из Китая", uk: "жінка з Китаю" }, decoys: ["китаец", "японка", "корейска"] },
  { q: "Румъния (м.)", answer: "румънец", hint: { ru: "мужчина из Румынии", uk: "чоловік з Румунії" }, decoys: ["румънка", "унгарец", "българин"] },
  { q: "Румъния (ж.)", answer: "румънка", hint: { ru: "женщина из Румынии", uk: "жінка з Румунії" }, decoys: ["румънец", "унгарка", "българка"] },
  { q: "Холандия (м.)", answer: "холандец", hint: { ru: "мужчина из Нидерландов", uk: "чоловік з Нідерландів" }, decoys: ["холандка", "германец", "белгиец"] },
  { q: "Холандия (ж.)", answer: "холандка", hint: { ru: "женщина из Нидерландов", uk: "жінка з Нідерландів" }, decoys: ["холандец", "германка", "белгийка"] },
];
...
export const DATA_PROFESSION: DataItem[] = [
  ...
  { q: "лекар", answer: "лекарка", hint: { ru: "врач → ж.р.", uk: "лікар → ж.р." }, decoys: ["студентка", "учителка", "писателка"] },
  { q: "учител", answer: "учителка", hint: { ru: "учитель → ж.р.", uk: "вчитель → ж.р." }, decoys: ["студентка", "преподавателка", "лекарка"] },
  { q: "певец", answer: "певица", hint: { ru: "певец → ж.р.", uk: "співак → ж.р." }, decoys: ["актриса", "студентка", "писателка"] },
  { q: "продавач", answer: "продавачка", hint: { ru: "продавец → ж.р.", uk: "продавець → ж.р." }, decoys: ["учителка", "студентка", "журналистка"] },
  { q: "преводач", answer: "преводачка", hint: { ru: "переводчик → ж.р.", uk: "перекладач → ж.р." }, decoys: ["журналистка", "писателка", "учителка"] },
  { q: "художник", answer: "художничка", hint: { ru: "художник → ж.р.", uk: "художник → ж.р." }, decoys: ["актриса", "писателка", "учителка"] },
];
...
export const DATA_GREETING: DataItem[] = [
  ...
  { q: "08:00 ☕", answer: "Добро утро", hint: { ru: "утро (до 11:00)", uk: "ранок (до 11:00)" }, rule: GREETING_RULE },
  { q: "10:30 🥐", answer: "Добро утро", hint: { ru: "утро (до 11:00)", uk: "ранок (до 11:00)" }, rule: GREETING_RULE },
  { q: "12:00 🍽", answer: "Добър ден", hint: { ru: "день (11:00–18:00)", uk: "день (11:00–18:00)" }, rule: GREETING_RULE },
  { q: "16:00 🏛", answer: "Добър ден", hint: { ru: "день (11:00–18:00)", uk: "день (11:00–18:00)" }, rule: GREETING_RULE },
  { q: "18:30 🍷", answer: "Добър вечер", hint: { ru: "вечер (18:00–22:00)", uk: "вечір (18:00–22:00)" }, rule: GREETING_RULE },
  { q: "20:00 🎭", answer: "Добър вечер", hint: { ru: "вечер (18:00–22:00)", uk: "вечір (18:00–22:00)" }, rule: GREETING_RULE },
  { q: "22:30 🌌", answer: "Лека нощ", hint: { ru: "ночь (после 22:00)", uk: "ніч (після 22:00)" }, rule: GREETING_RULE },
  { q: "06:30 🌅", answer: "Добро утро", hint: { ru: "утро (до 11:00)", uk: "ранок (до 11:00)" }, rule: GREETING_RULE },
];
...
export const DATA_NALI: DataItem[] = [
  ...
  { q: "Имате тетрадка, нали? 👍", answer: "Да", hint: NALI_HINT_YES },
  { q: "Тя говори английски, нали? 👎", answer: "Не", hint: NALI_HINT_NO },
  { q: "Ти си писател, нали? 👍", answer: "Да", hint: NALI_HINT_YES },
  { q: "Те са приятели, нали? 👎", answer: "Не", hint: NALI_HINT_NO },
  { q: "Знаеш къде е, нали? 👍", answer: "Да", hint: NALI_HINT_YES },
  { q: "Той е от Полша, нали? 👎", answer: "Не", hint: NALI_HINT_NO },
  { q: "Учиш български, нали? 👍", answer: "Да", hint: NALI_HINT_YES },
  { q: "Имате речник, нали? 👎", answer: "Не", hint: NALI_HINT_NO },
];
...
export const DATA_NITO_I: DataItem[] = [
  ...
  { q: "Имам ___ молив, ___ химикалка", answer: "и", hint: NITO_HINT_AFFIRM_SHORT, rule: NITO_I_RULE },
  { q: "Нямам ___ книга, ___ речник", answer: "нито", hint: NITO_HINT_NEG_SHORT, rule: NITO_I_RULE },
  { q: "Знам ___ полски, ___ чешки", answer: "и", hint: NITO_HINT_AFFIRM_SHORT, rule: NITO_I_RULE },
  { q: "Не обичам ___ риба, ___ месо", answer: "нито", hint: NITO_HINT_NEG_SHORT, rule: NITO_I_RULE },
  { q: "Той говори ___ немски, ___ френски", answer: "и", hint: NITO_HINT_AFFIRM_SHORT, rule: NITO_I_RULE },
  { q: "Тя няма ___ брат, ___ сестра", answer: "нито", hint: NITO_HINT_NEG_SHORT, rule: NITO_I_RULE },
  { q: "Имаме ___ куче, ___ котка", answer: "и", hint: NITO_HINT_AFFIRM_SHORT, rule: NITO_I_RULE },
  { q: "Не разбирам ___ испански, ___ италиански", answer: "нито", hint: NITO_HINT_NEG_SHORT, rule: NITO_I_RULE },
];
...
export const DATA_KAK_SI: DataItem[] = [
  ...
  { q: "🥳", answer: "Много добре", label: { ru: "праздник", uk: "свято" }, hint: { ru: "очень хорошо", uk: "дуже добре" } },
  { q: "💪", answer: "Много добре", label: { ru: "бодро", uk: "бадьоро" }, hint: { ru: "очень хорошо", uk: "дуже добре" } },
  { q: "✌️", answer: "Добре", label: { ru: "хорошо", uk: "добре" }, hint: { ru: "хорошо", uk: "добре" } },
  { q: "😊", answer: "Добре", label: { ru: "хорошо", uk: "добре" }, hint: { ru: "хорошо", uk: "добре" } },
  { q: "😑", answer: "Горе-долу", label: { ru: "так себе", uk: "так собі" }, hint: { ru: "средне", uk: "так собі" } },
  { q: "😶", answer: "Горе-долу", label: { ru: "никак", uk: "ніяк" }, hint: { ru: "средне", uk: "так собі" } },
  { q: "😢", answer: "Не много добре", label: { ru: "грустно", uk: "сумно" }, hint: { ru: "не очень хорошо", uk: "не дуже добре" } },
  { q: "🤕", answer: "Не много добре", label: { ru: "болит", uk: "болить" }, hint: { ru: "не очень хорошо", uk: "не дуже добре" } },
];
...
export const DATA_TOVA: DataItem[] = [
  ...
  { q: "стол", answer: "Това е", hint: { ru: "стул (ед.)", uk: "стілець (одн.)" }, rule: TOVA_RULE },
  { q: "столове", answer: "Това са", hint: { ru: "стулья (мн.)", uk: "стільці (мн.)" }, rule: TOVA_RULE },
  { q: "маса", answer: "Това е", hint: { ru: "стол (ед.)", uk: "стіл (одн.)" }, rule: TOVA_RULE },
  { q: "маси", answer: "Това са", hint: { ru: "столы (мн.)", uk: "столи (мн.)" }, rule: TOVA_RULE },
  { q: "куче", answer: "Това е", hint: { ru: "собака (ед.)", uk: "собака (одн.)" }, rule: TOVA_RULE },
  { q: "кучета", answer: "Това са", hint: { ru: "собаки (мн.)", uk: "собаки (мн.)" }, rule: TOVA_RULE },
  { q: "дете", answer: "Това е", hint: { ru: "ребёнок (ед.)", uk: "дитина (одн.)" }, rule: TOVA_RULE },
  { q: "деца", answer: "Това са", hint: { ru: "дети (мн.)", uk: "діти (мн.)" }, rule: TOVA_RULE },
  { q: "ябълка", answer: "Това е", hint: { ru: "яблоко (ед.)", uk: "яблуко (одн.)" }, rule: TOVA_RULE },
  { q: "ябълки", answer: "Това са", hint: { ru: "яблоки (мн.)", uk: "яблука (мн.)" }, rule: TOVA_RULE },
  { q: "учител", answer: "Това е", hint: { ru: "учитель (ед.)", uk: "вчитель (одн.)" }, rule: TOVA_RULE },
  { q: "учители", answer: "Това са", hint: { ru: "учителя (мн.)", uk: "вчителі (мн.)" }, rule: TOVA_RULE },
  { q: "приятел", answer: "Това е", hint: { ru: "друг (ед.)", uk: "друг (одн.)" }, rule: TOVA_RULE },
  { q: "приятели", answer: "Това са", hint: { ru: "друзья (мн.)", uk: "друзі (мн.)" }, rule: TOVA_RULE },
];
...
export const DATA_OBJECTS: DataItem[] = [
  ...
  { q: "учебник / підручник", answer: "учебник", hint: HINT_LESSON_OBJECT, decoys: ["тетрадка", "речник", "бележник"] },
  { q: "стол / стіл", answer: "маса", hint: HINT_LESSON_OBJECT, decoys: ["стол", "чанта", "книга"] },
  { q: "стул / стілець", answer: "стол", hint: HINT_LESSON_OBJECT, decoys: ["маса", "чанта", "молив"] },
  { q: "доска / дошка", answer: "дъска", hint: HINT_LESSON_OBJECT, decoys: ["маса", "стол", "чанта"] },
  { q: "окно / вікно", answer: "прозорец", hint: HINT_LESSON_OBJECT, decoys: ["врата", "маса", "дъска"] },
  { q: "дверь / двері", answer: "врата", hint: HINT_LESSON_OBJECT, decoys: ["прозорец", "стол", "дъска"] },
  { q: "телефон", answer: "телефон", hint: HINT_LESSON_OBJECT, decoys: ["компютър", "молив", "чанта"] },
  { q: "компьютер / комп'ютер", answer: "компютър", hint: HINT_LESSON_OBJECT, decoys: ["телефон", "речник", "учебник"] },
];
...
export const DATA_REPLY: DataItem[] = [
  ...
  { q: "— Здрасти!", answer: "Здрасти!", hint: { ru: "разг. ответ на привет", uk: "розм. відповідь на привіт" }, decoys: ["Здравейте!", "Довиждане!", "Чао!"] },
  { q: "— Всичко хубаво!", answer: "Всичко хубаво!", hint: { ru: "всего доброго (взаимно)", uk: "всього найкращого (взаємно)" }, decoys: ["Приятно ми е", "Благодаря", "Здравей!"] },
  { q: "— Как си, Иван?", answer: "Благодаря, добре", hint: { ru: "как дела, Иван?", uk: "як справи, Іване?" }, decoys: ["Приятно ми е", "Чао!", "Лека нощ!"] },
  { q: "— Благодаря!", answer: "Моля", hint: { ru: "спасибо → пожалуйста", uk: "дякую → будь ласка" }, decoys: ["Здравей!", "Чао!", "Довиждане!"] },
  { q: "— Извинете!", answer: "Няма проблем", hint: { ru: "извините → нет проблем", uk: "вибачте → немає проблем" }, decoys: ["Здравейте!", "Чао!", "Лека нощ!"] },
  { q: "— Аз съм Мария", answer: "Приятно ми е", hint: { ru: "знакомство", uk: "знайомство" }, decoys: ["Благодаря", "Чао!", "Лека нощ!"] },
  { q: "— Как сте, господин Донков?", answer: "Благодаря, добре. А Вие?", hint: { ru: "как дела (Вы)", uk: "як справи (Ви)" }, decoys: ["Приятно ми е", "Чао!", "Лека нощ!"] },
  { q: "— Откъде сте?", answer: "От България съм", hint: { ru: "откуда Вы?", uk: "звідки Ви?" }, decoys: ["Казвам се Иван", "Студент съм", "Приятно ми е"] },
  { q: "— Как се казвате?", answer: "Казвам се Иван", hint: { ru: "как Вас зовут?", uk: "як Вас звати?" }, decoys: ["От България съм", "Студент съм", "Приятно ми е"] },
  { q: "— Говорите ли български?", answer: "Да, говоря", hint: { ru: "говорите ли по-болгарски?", uk: "розмовляєте болгарською?" }, decoys: ["Не, благодаря", "Здравейте!", "Чао!"] },
];
...
export const DATA_LI: LiItem[] = [
  ...
  { words: ["Имаш", "молив"], liPosition: 0, result: "Имаш ли молив?", translation: { ru: "*Есть* у тебя карандаш?", uk: "*Маєш* олівець?" } },
  { words: ["Имаш", "тетрадка"], liPosition: 0, result: "Имаш ли тетрадка?", translation: { ru: "*Есть* у тебя тетрадь?", uk: "*Маєш* зошит?" } },
  { words: ["Говорите", "английски"], liPosition: 0, result: "Говорите ли английски?", translation: { ru: "Вы *говорите* по-английски?", uk: "Ви *розмовляєте* англійською?" } },
  { words: ["Разбирате", "ме"], liPosition: 0, result: "Разбирате ли ме?", translation: { ru: "*Понимаете* меня?", uk: "*Розумієте* мене?" } },
  { words: ["Имате", "време"], liPosition: 0, result: "Имате ли време?", translation: { ru: "*Есть* у Вас время?", uk: "*Маєте* час?" } },
  { words: ["Знаеш", "български"], liPosition: 0, result: "Знаеш ли български?", translation: { ru: "*Знаешь* болгарский?", uk: "*Знаєш* болгарську?" } },
  { words: ["Помниш", "ме"], liPosition: 0, result: "Помниш ли ме?", translation: { ru: "*Помнишь* меня?", uk: "*Пам'ятаєш* мене?" } },
  { words: ["Виждаш", "го"], liPosition: 0, result: "Виждаш ли го?", translation: { ru: "*Видишь* его?", uk: "*Бачиш* його?" } },
  { words: ["Чуваш", "ме"], liPosition: 0, result: "Чуваш ли ме?", translation: { ru: "*Слышишь* меня?", uk: "*Чуєш* мене?" } },
  { words: ["Идваш", "довечера"], liPosition: 0, result: "Идваш ли довечера?", translation: { ru: "*Придёшь* вечером?", uk: "*Прийдеш* увечері?" } },
  { words: ["Готов", "си"], liPosition: 0, result: "Готов ли си?", translation: { ru: "*Готов*?", uk: "*Готовий*?" } },
  { words: ["Студент", "си"], liPosition: 0, result: "Студент ли си?", translation: { ru: "*Студент*?", uk: "*Студент*?" } },
  { words: ["Българка", "си"], liPosition: 0, result: "Българка ли си?", translation: { ru: "*Болгарка*?", uk: "*Болгарка*?" } },
];
...
export const DATA_MATCH_COUNTRY_LANG: MatchItem[] = [
  ...
  { left: "Англия", right: "английски", hint: HINT_COUNTRY_LANG },
  { left: "Австрия", right: "немски", hint: HINT_COUNTRY_LANG },
  { left: "Румъния", right: "румънски", hint: HINT_COUNTRY_LANG },
  { left: "Хърватия", right: "хърватски", hint: HINT_COUNTRY_LANG },
  { left: "Словакия", right: "словашки", hint: HINT_COUNTRY_LANG },
  { left: "Словения", right: "словенски", hint: HINT_COUNTRY_LANG },
  { left: "Македония", right: "македонски", hint: HINT_COUNTRY_LANG },
  { left: "Албания", right: "албански", hint: HINT_COUNTRY_LANG },
  { left: "Холандия", right: "нидерландски", hint: HINT_COUNTRY_LANG },
  { left: "Португалия", right: "португалски", hint: HINT_COUNTRY_LANG },
  { left: "Корея", right: "корейски", hint: HINT_COUNTRY_LANG },
  { left: "Украйна", right: "украински", hint: HINT_COUNTRY_LANG },
  { left: "Виетнам", right: "виетнамски", hint: HINT_COUNTRY_LANG },
];
...
export const DATA_MATCH_COUNTRY_NAT_M: MatchItem[] = [
  ...
  { left: "Испания", right: "испанец", hint: HINT_COUNTRY_NAT_M },
  { left: "Франция", right: "французин", hint: HINT_COUNTRY_NAT_M },
  { left: "Чехия", right: "чех", hint: HINT_COUNTRY_NAT_M },
  { left: "Унгария", right: "унгарец", hint: HINT_COUNTRY_NAT_M },
  { left: "Румъния", right: "румънец", hint: HINT_COUNTRY_NAT_M },
  { left: "Холандия", right: "холандец", hint: HINT_COUNTRY_NAT_M },
  { left: "Хърватия", right: "хърватин", hint: HINT_COUNTRY_NAT_M },
  { left: "Словакия", right: "словак", hint: HINT_COUNTRY_NAT_M },
  { left: "Словения", right: "словенец", hint: HINT_COUNTRY_NAT_M },
  { left: "Македония", right: "македонец", hint: HINT_COUNTRY_NAT_M },
];
...
export const DATA_MATCH_PROFESSION: MatchItem[] = [
  ...
  { left: "лекар", right: "лекарка", hint: HINT_PROF_MF },
  { left: "учител", right: "учителка", hint: HINT_PROF_MF },
  { left: "певец", right: "певица", hint: HINT_PROF_MF },
  { left: "продавач", right: "продавачка", hint: HINT_PROF_MF },
  { left: "преводач", right: "преводачка", hint: HINT_PROF_MF },
  { left: "художник", right: "художничка", hint: HINT_PROF_MF },
];
...
export const DATA_ODD_MIXED: OddItem[] = [
  ...
  { words: ["казвам", "казваш", "казва", "имам"], odd: "имам", hint: ODD_HINT_PARADIGM },
  { words: ["говорим", "говорите", "говорят", "имаш"], odd: "имаш", hint: ODD_HINT_PARADIGM },
  { words: ["искаме", "искате", "искат", "сте"], odd: "сте", hint: ODD_HINT_PARADIGM },
  { words: ["нямаме", "нямате", "нямат", "имам"], odd: "имам", hint: ODD_HINT_PARADIGM },
  { words: ["учител", "брат", "син", "майка"], odd: "майка", hint: ODD_HINT_GENDER_M },
  { words: ["приятел", "език", "син", "сестра"], odd: "сестра", hint: ODD_HINT_GENDER_M },
  { words: ["сестра", "майка", "държава", "стол"], odd: "стол", hint: ODD_HINT_GENDER_F },
  { words: ["химикалка", "тетрадка", "чанта", "молив"], odd: "молив", hint: ODD_HINT_GENDER_F },
  { words: ["куче", "момче", "момиче", "чанта"], odd: "чанта", hint: ODD_HINT_GENDER_N },
  { words: ["сърце", "име", "писмо", "брат"], odd: "брат", hint: ODD_HINT_GENDER_N },
  { words: ["българин", "руснак", "руски", "грък"], odd: "руски", hint: ODD_HINT_NAT },
  { words: ["италианец", "испанец", "италиански", "французин"], odd: "италиански", hint: ODD_HINT_NAT },
  { words: ["английски", "немски", "италиански", "руснак"], odd: "руснак", hint: ODD_HINT_LANG },
  { words: ["сръбски", "хърватски", "словенски", "словак"], odd: "словак", hint: ODD_HINT_LANG },
  { words: ["казвам се", "казваш се", "казва се", "съм"], odd: "съм", hint: ODD_HINT_PARADIGM },
  { words: ["имаме", "имате", "имат", "искам"], odd: "искам", hint: ODD_HINT_PARADIGM },
];
...
export const DATA_TRANSFORM_NEG: DataItem[] = [
  ...
  { q: "Аз съм българин", answer: "Аз не съм българин", hint: HINT_NEG, rule: TRANS_NEG_RULE, decoys: ["Аз съм не българин", "Не аз съм българин", "Аз българин не съм"] },
  { q: "Той говори български", answer: "Той не говори български", hint: HINT_NEG, rule: TRANS_NEG_RULE, decoys: ["Той говори не български", "Не той говори български", "Той български не говори"] },
  { q: "Тя има куче", answer: "Тя няма куче", hint: { ru: "«има» → «няма»", uk: "«има» → «няма»" }, rule: TRANS_NEG_RULE, decoys: ["Тя не има куче", "Тя има не куче", "Не тя има куче"] },
  { q: "Имаш молив", answer: "Нямаш молив", hint: { ru: "«имаш» → «нямаш»", uk: "«имаш» → «нямаш»" }, rule: TRANS_NEG_RULE, decoys: ["Не имаш молив", "Имаш не молив", "Молив нямаш"] },
  { q: "Те имат деца", answer: "Те нямат деца", hint: { ru: "«имат» → «нямат»", uk: "«имат» → «нямат»" }, rule: TRANS_NEG_RULE, decoys: ["Те не имат деца", "Те имат не деца", "Не те имат деца"] },
  { q: "Ние говорим английски", answer: "Ние не говорим английски", hint: HINT_NEG, rule: TRANS_NEG_RULE, decoys: ["Ние говорим не английски", "Не ние говорим английски", "Ние английски не говорим"] },
  { q: "Знам отговора", answer: "Не знам отговора", hint: HINT_NEG, rule: TRANS_NEG_RULE, decoys: ["Знам не отговора", "Знам отговора не", "Отговора знам не"] },
  { q: "Той е от Полша", answer: "Той не е от Полша", hint: HINT_NEG, rule: TRANS_NEG_RULE, decoys: ["Той е не от Полша", "Не той е от Полша", "Той от Полша не е"] },
  { q: "Аз искам кафе", answer: "Аз не искам кафе", hint: HINT_NEG, rule: TRANS_NEG_RULE, decoys: ["Аз искам не кафе", "Не аз искам кафе", "Аз кафе не искам"] },
  { q: "Те живеят тук", answer: "Те не живеят тук", hint: HINT_NEG, rule: TRANS_NEG_RULE, decoys: ["Те живеят не тук", "Не те живеят тук", "Те тук не живеят"] },
];
...
export const DATA_TRANSFORM_Q: DataItem[] = [
  ...
  { q: "Аз съм фотограф", answer: "Аз ли съм фотограф?", hint: HINT_Q_SUBJ, rule: TRANS_Q_RULE, decoys: ["Аз съм ли фотограф?", "Аз съм фотограф ли?", "Ли аз съм фотограф?"] },
  { q: "Ние сме приятели", answer: "Ние ли сме приятели?", hint: HINT_Q_SUBJ, rule: TRANS_Q_RULE, decoys: ["Ние сме ли приятели?", "Ние сме приятели ли?", "Ли ние сме приятели?"] },
  { q: "Тя е от България", answer: "Тя ли е от България?", hint: HINT_Q_SUBJ, rule: TRANS_Q_RULE, decoys: ["Тя е ли от България?", "Тя е от България ли?", "Ли тя е от България?"] },
  { q: "Той има време", answer: "Той ли има време?", hint: HINT_Q_SUBJ, rule: TRANS_Q_RULE, decoys: ["Той има ли време?", "Той има време ли?", "Ли той има време?"] },
  { q: "Ти имаш молив", answer: "Ти ли имаш молив?", hint: HINT_Q_SUBJ, rule: TRANS_Q_RULE, decoys: ["Ти имаш ли молив?", "Ти имаш молив ли?", "Ли ти имаш молив?"] },
  { q: "Те са от Полша", answer: "Те ли са от Полша?", hint: HINT_Q_SUBJ, rule: TRANS_Q_RULE, decoys: ["Те са ли от Полша?", "Те са от Полша ли?", "Ли те са от Полша?"] },
  { q: "Тя говори английски", answer: "Тя ли говори английски?", hint: HINT_Q_SUBJ, rule: TRANS_Q_RULE, decoys: ["Тя говори ли английски?", "Тя говори английски ли?", "Ли тя говори английски?"] },
];
...
export const DATA_REGISTER_TIVIE: DataItem[] = [
  ...
  { q: "Ти си българин", answer: "Вие сте българин", hint: HINT_REGISTER, rule: REGISTER_RULE, decoys: ["Вие си българин", "Ти сте българин", "Вие са българин"] },
  { q: "Говориш ли английски?", answer: "Говорите ли английски?", hint: HINT_REGISTER, rule: REGISTER_RULE, decoys: ["Говори ли английски?", "Говорят ли английски?", "Говорим ли английски?"] },
  { q: "Имаш молив", answer: "Имате молив", hint: HINT_REGISTER, rule: REGISTER_RULE, decoys: ["Имам молив", "Имат молив", "Има молив"] },
  { q: "Ти ли си от Гърция?", answer: "Вие ли сте от Гърция?", hint: HINT_REGISTER, rule: REGISTER_RULE, decoys: ["Вие ли си от Гърция?", "Ти ли сте от Гърция?", "Ти ли са от Гърция?"] },
  { q: "Знаеш ли отговора?", answer: "Знаете ли отговора?", hint: HINT_REGISTER, rule: REGISTER_RULE, decoys: ["Знае ли отговора?", "Знаят ли отговора?", "Знаем ли отговора?"] },
  { q: "Идваш ли довечера?", answer: "Идвате ли довечера?", hint: HINT_REGISTER, rule: REGISTER_RULE, decoys: ["Идва ли довечера?", "Идват ли довечера?", "Идваме ли довечера?"] },
  { q: "Учиш ли български?", answer: "Учите ли български?", hint: HINT_REGISTER, rule: REGISTER_RULE, decoys: ["Учи ли български?", "Учат ли български?", "Учим ли български?"] },
  { q: "Ти си журналистка", answer: "Вие сте журналистка", hint: HINT_REGISTER, rule: REGISTER_RULE, decoys: ["Вие си журналистка", "Ти сте журналистка", "Вие са журналистка"] },
];
...
export const DATA_PROFILE_BUILD: BuildItem[] = [
  ...
  { words: ["Той", "се", "казва", "Иван", ".", "Той", "е", "от", "Русия", ".", "Говори", "руски"], translation: { ru: "Его зовут Иван. Он из России. Говорит по-русски.", uk: "Його звати Іван. Він з Росії. Розмовляє російською." } },
  { words: ["Тя", "се", "казва", "Мария", ".", "Тя", "е", "от", "Италия", ".", "Говори", "италиански"], translation: { ru: "Её зовут Мария. Она из Италии. Говорит по-итальянски.", uk: "Її звати Марія. Вона з Італії. Розмовляє італійською." } },
  { words: ["Той", "се", "казва", "Хуан", ".", "Той", "е", "от", "Испания", ".", "Говори", "испански"], translation: { ru: "Его зовут Хуан. Он из Испании. Говорит по-испански.", uk: "Його звати Хуан. Він з Іспанії. Розмовляє іспанською." } },
  { words: ["Тя", "се", "казва", "Анна", ".", "Тя", "е", "от", "Украйна", ".", "Говори", "украински"], translation: { ru: "Её зовут Анна. Она из Украины. Говорит по-украински.", uk: "Її звати Анна. Вона з України. Розмовляє українською." } },
  { words: ["Той", "се", "казва", "Пьер", ".", "Той", "е", "от", "Франция", ".", "Говори", "френски"], translation: { ru: "Его зовут Пьер. Он из Франции. Говорит по-французски.", uk: "Його звати П'єр. Він з Франції. Розмовляє французькою." } },
  { words: ["Тя", "се", "казва", "Линг", ".", "Тя", "е", "от", "Китай", ".", "Говори", "китайски"], translation: { ru: "Её зовут Линг. Она из Китая. Говорит по-китайски.", uk: "Її звати Лінг. Вона з Китаю. Розмовляє китайською." } },
  { words: ["Той", "се", "казва", "Марко", ".", "Той", "е", "от", "Чехия", ".", "Говори", "чешки"], translation: { ru: "Его зовут Марко. Он из Чехии. Говорит по-чешски.", uk: "Його звати Марко. Він з Чехії. Розмовляє чеською." } },
];
