...
const VF_HINT_T: Localized<string> = { ru: "соответствует тексту", uk: "відповідає тексту" };
const VF_HINT_F: Localized<string> = { ru: "не соответствует тексту", uk: "не відповідає тексту" };
export const DATA_VF: DataItem[] = [
  { q: "Стаята на Мария е южна и светла.", answer: "Вярно", hint: VF_HINT_T },
  { q: "Стаята на Антон е тъмна.", answer: "Не е вярно", hint: VF_HINT_F },
  { q: "Стаята на Мария е разхвърляна.", answer: "Не е вярно", hint: VF_HINT_F },
  { q: "В стаята на Мария има много цветя.", answer: "Вярно", hint: VF_HINT_T },
  { q: "В стаята на Антон има две легла.", answer: "Вярно", hint: VF_HINT_T },
  { q: "В стаята на Мария има секция.", answer: "Не е вярно", hint: VF_HINT_F },
  { q: "В стаята на Антон е подредено.", answer: "Не е вярно", hint: VF_HINT_F },
  { q: "Над леглото на Мария има картина.", answer: "Вярно", hint: VF_HINT_T },
  { q: "Прозорецът на Антон е малък.", answer: "Не е вярно", hint: VF_HINT_F },
  { q: "В секцията на Антон има книги.", answer: "Вярно", hint: VF_HINT_T },
  { q: "Компютърът на Мария е на пода.", answer: "Не е вярно", hint: VF_HINT_F },
  { q: "Стаята на Мария е чиста.", answer: "Вярно", hint: VF_HINT_T },
];
export const VF_OPTIONS = ["Вярно", "Не е вярно"];
