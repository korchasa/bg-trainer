...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    modes: [
      { id: "l1_frame", icon: "🧠", label: { ru: "Построй предложение · L1", uk: "Побудуй речення · L1" }, desc: { ru: "Заполни роли словами из банка — слова надо вспомнить самому", uk: "Заповни ролі словами з банку — слова треба згадати самому" }, type: "frame", data: () => FRAME_L1 },
      { id: "l2_frame", icon: "🧠", label: { ru: "Построй предложение · L2", uk: "Побудуй речення · L2" }, desc: { ru: "Комната, артикль, предлоги места. Заполни роли словами из банка — слова надо вспомнить самому", uk: "Кімната, артикль, прийменники місця. Заповни ролі словами з банку — слова треба згадати самому" }, type: "frame", data: () => FRAME_L2 },
      { id: "l3_frame", icon: "🧠", label: { ru: "Построй предложение · L3", uk: "Побудуй речення · L3" }, desc: { ru: "Семья, жильё, дни. Пустые места без подсказок: число слов известно, порядок — нет", uk: "Родина, житло, дні. Порожні місця без підказок: число слів відоме, порядок — ні" }, type: "frame", data: () => FRAME_L3 },
      { id: "l4_frame", icon: "🧠", label: { ru: "Построй предложение · L4", uk: "Побудуй речення · L4" }, desc: { ru: "Распорядок дня, часы, прошедшее и будущее. Пустые места без подсказок: число слов известно, порядок — нет", uk: "Розпорядок дня, години, минуле й майбутнє. Порожні місця без підказок: число слів відоме, порядок — ні" }, type: "frame", data: () => FRAME_L4 },
      { id: "l5_frame", icon: "🧠", label: { ru: "Построй предложение · L5", uk: "Побудуй речення · L5" }, desc: { ru: "Внешность, цвета, будущее «ще». Пустая строка и слова урока: длину и порядок выбираешь сам", uk: "Зовнішність, кольори, майбутнє «ще». Порожній рядок і слова уроку: довжину й порядок обираєш сам" }, type: "frame", data: () => FRAME_L5 },
      { id: "l6_frame", icon: "🧠", label: { ru: "Построй предложение · L6", uk: "Побудуй речення · L6" }, desc: { ru: "Да-конструкция, движение, направления. Пустая строка и слова урока: длину и порядок выбираешь сам", uk: "Да-конструкція, рух, напрямки. Порожній рядок і слова уроку: довжину й порядок обираєш сам" }, type: "frame", data: () => FRAME_L6 },
      { id: "l7_frame", icon: "🧠", label: { ru: "Построй предложение · L7", uk: "Побудуй речення · L7" }, desc: { ru: "Покупки, степени сравнения, дательный. Без банка слов — предложение целиком с клавиатуры", uk: "Покупки, ступені порівняння, давальний. Без банку слів — речення цілком з клавіатури" }, type: "frame", data: () => FRAME_L7 },
      { id: "l8_frame", icon: "🧠", label: { ru: "Построй предложение · L8", uk: "Побудуй речення · L8" }, desc: { ru: "Еда, ресторан, прошедшее неопределённое. Без банка слов — предложение целиком с клавиатуры", uk: "Їжа, ресторан, минуле неозначене. Без банку слів — речення цілком з клавіатури" }, type: "frame", data: () => FRAME_L8 },
    ],
  },
  {
    id: "profile",
